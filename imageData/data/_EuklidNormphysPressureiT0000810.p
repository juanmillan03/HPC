...
set output './tmp/imageData/_EuklidNorm(physPressure)iT0000810.jpeg'
} else {set terminal png size 458,600font ",25"
set output './tmp/imageData/_EuklidNorm(physPressure)iT0000810.png'
}
set pm3d map
unset key
unset xtics
...
splot './tmp/imageData/data/_EuklidNorm(physPressure)iT0000810.matrix' u ($1*0.022+-0.025):($2*0.022+-0.032217):3 matrix with pm3d
